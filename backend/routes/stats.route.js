...
router.get("/hopital/:hopitalId", async (req, res) => {
  try {
    ...
    //  Interventions groupées par gravité
    ...
    //  Liste complète des ambulances avec détails
    const ambulances = await Ambulance.find({ hopitalId: new ObjectId(hopitalId) });

    //  Nombre et liste des ambulanciers avec détails
    ...
    //  Tous les appels de cet hôpital avec détails
